...
<div class="container">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td><c:out value="${bill.client.name}"></c:out></td>
            <td><c:out value="${bill.client.phonenumber}"></c:out></td>
            <td><c:out value="${bill.client.address}"></c:out></td>
            <td><c:out value="${bill.description}"></c:out></td>
            <td><c:out value="${bill.total}"></c:out></td>
            <td>
                <a href="ServletDeleteBill?id=${bill.id}">Delete</a>
            </td>
        </tr>
        </c:forEach>
        </tbody>
