    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <a href="ServletProduct">Product</a>
            </div>
        </div>
    </div>
</div>
            ...
            <c:forEach var="product" items="${product_list}">
                <div class="col-lg-4 col-md-6">
                    <div class="service-item">
                        ...
                        <h3>${product.name}</h3>
                        <p>${product.price}</p>
                        <a class="btn" onclick="addToCart(${product.id})"><span class="glyphicon glyphicon-shopping-cart"></span></a>
                    </div>
                </div>
            </c:forEach>
        </div>
...
<script>
    function addToCart(id){
        window.location.href ='ServletAddtoCart?id='+id;
    }
</script>
